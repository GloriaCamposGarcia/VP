...
def run_use_pipeline():
    ...
    """
    logger.info("==================================================")
    logger.info("INICIO DE PIPELINE DE USO / INFERENCIA AML ")
    logger.info("==================================================")
    
    # 1. Procesamiento de datos crudos para la nueva corrida
    ...
    # 3. Clustering semántico y embeddings
    logger.info("Paso 3: Inferencia de clustering semántico en progreso.")
    execute_clustering_pipeline()
    
    # 4. Modelos de detección de anomalías
    logger.info("Paso 4: Generación de los modelos de anomalías en progreso.")
    ...
    # 6. Gneneración del reporte final y visualizaciones
